...
public class OrdersMap {
    public static void main(String[] args) {
        ...
        while (!"buy".equals(input=scan.nextLine())){
            ...
            products.put(command[0],setArray(Double.parseDouble(command[1]),Double.parseDouble(command[2]),products.get(command[0])));
        }
    ...
    static double[] setArray(double price,double quantity,double[] array) {
        ...
        newArray[0]=price; newArray[1]=array[1]+quantity;
        return newArray;
    }
