...
public class CountRealNumbers {
    public static void main(String[] args) {
        ...
        Arrays.stream(num).forEach(v -> { if (!output.containsKey(v)) { output.put(v, 0); }output.put(v, output.get(v) + 1); });
        output.forEach((key, value) -> { DecimalFormat df = new DecimalFormat("#.########");
