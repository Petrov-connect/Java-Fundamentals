...
public class SeizeTheFire {
    public static void main(String[] args) {
        ...
        double effort=0.0; int totalFire=0;
        List<String>output=new ArrayList<>(); output.add(0,"Cells:");
        for (String cell : cells) {
            ...
            if(isValid&&water>=firePower){
                water-=firePower; effort+=firePower*0.25; output.add(" - "+firePower); totalFire+=firePower;
            }
        }
