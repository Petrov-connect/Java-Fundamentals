...
public class ArrayManipulator {
    ...
    private static String getLastOddEvenNumbers(int[] arr, String[] command) {
        ...
        int countOdd=Integer.parseInt(command[1]); int countEven=Integer.parseInt(command[1]);
    ...
    private static int getMinEvenOddIndex(int[] arr,String []command) {
        int minOddIndex=-1; int minEvenIndex=-1; int minOdd=Integer.MAX_VALUE; int minEven=Integer.MAX_VALUE;
    ...
    private static int getMaxEvenOddIndex(int[] arr,String []command) {
        int maxOddIndex = -1; int maxEvenIndex = -1; int maxEven = Integer.MIN_VALUE; int maxOdd = Integer.MIN_VALUE;
        for (int i = 0; i < arr.length; i++) {
