...
public class Songs {
    static class Song {
        private String typeList; private String getTypeList() { return typeList; } private void setTypeList(String typeList) { this.typeList = typeList; }
        String name; public void setName(String name) { this.name = name; } public String getName() { return name; }
        String time; public void setTime(String time) { this.time = time; }
    }
