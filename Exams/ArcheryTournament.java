...
public class ArcheryTournament {
    public static void main(String[] args) {
        ...
        List<Integer> archeryField= Arrays.stream(scan.nextLine().split("\\|+")).map(Integer::parseInt).collect(Collectors.toList());
        String input; int points=0;
        ...
        System.out.println(archeryField.toString().replaceAll("[\\[\\]]","").replaceAll(","," -"));
